...
function draw() { // draw function is where the code compile
	background(35,255,canvBG); // it tells us the background function 
	...
	ellipse(circX + 80, circY - 25, circSize, circSize); // ellipse function tell us adding to the variable set  +  80 and -25, the position of the ellipse is offset against the other.
    ...
    fill(255,recCol,0);// fill function would fill the recCol color. 
